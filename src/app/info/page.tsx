...
export default function InfoPage() {
  return (
    <div className="flex min-h-screen flex-col items-center">
      <main className="flex min-h-screen w-[90%] max-w-[var(--content-sm-max)] flex-col justify-center px-[var(--page-gutter)] pb-[var(--home-page-padding-bottom)]">
        <GalleryRow
          tracks={[3,.5, 1]}
          measure="content"
          gap="large"
        ...
        <div className="flex h-full min-h-0 w-full min-w-0 flex-col justify-center gap-[var(--space-xl)] md:max-w-[min(100%,42rem)] md:pr-[var(--space-lg)]">
          ...
          <dl className="m-0 grid grid-cols-[minmax(0,auto)_1fr] gap-x-[var(--space-m)] gap-y-[var(--space-lg)] text-default">
            ...
            <dd className="type-body m-0 min-w-0 text-pretty">
            <p className="m-0">
              I want to design tools &amp;
                complex systems that empower{" "}
                <em className="italic">people</em> to focus more on imagining, exploring, and creating.
              </p>
    ...
    <div aria-hidden className="min-h-0 min-w-0" />
        <div className="flex min-h-0 w-full min-w-0 flex-col items-center justify-center md:items-end">
          <div className="relative flex w-full max-w-xl items-center justify-end pb-[var(--space-48)]">
